  ...
  for (current_house_type in house_types) {
    ...
    for (furnace_fuel in furnace_fuels) {
      ...
      for (hp_backup in current_backup_options) {
        ...
        source("Scripts_Poster_1/2_load_available_hps/load_available_hps_paper.R")
        
        ######## 3: Backup furnace cost calculation (*** furnace life left ***) ----
        
        source("Scripts_Poster_1/3_furnace_cost_calc/furnace_cost_calc_paper.R")
        ...
        source("Scripts_Poster_1/10_marginal_abatement_cost/marginal_abatement_cost_paper.R")
        
        ###
        
        source("Scripts_Poster_1/10_marginal_abatement_cost/scaled_marginal_abatement_cost_paper.R")
        ...
        source("Scripts_Poster_1/13_combined_elec_load_plot_c&h/combined_elec_load_plot_c&h_paper.R")
        ...
        source("Scripts_Poster_1/14_cost_comparison/social_and_private_marginal_abatement_cost_paper.R")
...
source("Scripts_Poster_1/19_mac/mac_various_GT_newfinal.R")

###

source("Scripts_Poster_1/20_annual_cost_saving/cost/annual_cost_saving_finalnew.R")

###

source("Scripts_Poster_1/21_load_VS_GHG/load_VS_GHG.R")
