...
mac_various <- 
  bind_rows(
    cost_comparison(homes_data=representative_homes, hourly_temperature = weather_fsa$temperature,hp_data=hpn, hp_equip_cost_data=hp_equip_cost_data, rebate=0, ir=0.07, irr=0, ctax=0, life=15, hp_backup="gas", cp=cycling_cop_penalty, mood="Cost") %>%
      bind_cols(tibble(scenario = "base")),
    cost_comparison(homes_data=representative_homes, hourly_temperature = weather_fsa$temperature,hp_data=hpn, hp_equip_cost_data=hp_equip_cost_data, rebate=5000, ir=0.07, irr=0, ctax=0, life=15, hp_backup="gas", cp=cycling_cop_penalty, mood="Cost") %>%
      bind_cols(tibble(scenario = "Rebate5K")),
    cost_comparison(homes_data=representative_homes, hourly_temperature = weather_fsa$temperature,hp_data=hpn, hp_equip_cost_data=hp_equip_cost_data, rebate=5000, ir=0.07, irr=0.06, ctax=0, life=15, hp_backup="gas", cp=cycling_cop_penalty, mood="Cost") %>%
      bind_cols(tibble(scenario = "Rebate5K+lowinterest")),
    cost_comparison(homes_data=representative_homes, hourly_temperature = weather_fsa$temperature,hp_data=hpn, hp_equip_cost_data=hp_equip_cost_data, rebate=10000, ir=0.07, irr=0, ctax=0, life=15, hp_backup="gas", cp=cycling_cop_penalty, mood="Cost") %>%
      bind_cols(tibble(scenario = "Rebate10K")),
    cost_comparison(homes_data=representative_homes, hourly_temperature = weather_fsa$temperature,hp_data=hpn, hp_equip_cost_data=hp_equip_cost_data, rebate=10000, ir=0.07, irr=0.06, ctax=0, life=15, hp_backup="gas", cp=cycling_cop_penalty, mood="Cost") %>%
      bind_cols(tibble(scenario = "Rebate10K+lowinterest")),
    cost_comparison(homes_data=representative_homes, hourly_temperature = weather_fsa$temperature,hp_data=hpn, hp_equip_cost_data=hp_equip_cost_data, rebate=5000, ir=0.07, irr=0, ctax=95, life=15, hp_backup="gas", cp=cycling_cop_penalty, mood="Cost") %>%
      bind_cols(tibble(scenario = "Rebate5K+ctax95")),
    cost_comparison(homes_data=representative_homes, hourly_temperature = weather_fsa$temperature,hp_data=hpn, hp_equip_cost_data=hp_equip_cost_data, rebate=10000, ir=0.07, irr=0, ctax=95, life=15, hp_backup="gas", cp=cycling_cop_penalty, mood="Cost") %>%
      bind_cols(tibble(scenario = "Rebate10K+ctax95")),
    cost_comparison(homes_data=representative_homes, hourly_temperature = weather_fsa$temperature,hp_data=hpn, hp_equip_cost_data=hp_equip_cost_data, rebate=5000, ir=0.07, irr=0, ctax=170, life=15, hp_backup="gas", cp=cycling_cop_penalty, mood="Cost") %>%
      bind_cols(tibble(scenario = "Rebate5K+ctax170")),
    cost_comparison(homes_data=representative_homes, hourly_temperature = weather_fsa$temperature,hp_data=hpn, hp_equip_cost_data=hp_equip_cost_data, rebate=10000, ir=0.07, irr=0, ctax=170, life=15, hp_backup="gas", cp=cycling_cop_penalty, mood="Cost") %>%
